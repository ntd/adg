...
main(int argc, char *argv[])
{
    ...
    adg_test_add_func("/adg/color-style/alpha", _adg_test_alpha);
    adg_test_add_func("/adg/color-style/blue", _adg_test_blue);
    adg_test_add_func("/adg/color-style/green", _adg_test_green);
    adg_test_add_func("/adg/color-style/red", _adg_test_red);
