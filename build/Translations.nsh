; Translations for adg.nsi script.
;
...
LangString TITLE_SecBase	${LANG_ENGLISH}		"ADG canvas"
LangString TITLE_SecBase	${LANG_ITALIAN}		"Canvas ADG"
...
LangString TITLE_SecLanguages	${LANG_ENGLISH}		"Support for languages"
LangString TITLE_SecLanguages	${LANG_ITALIAN}		"Supporto lingue"
